...
public class Ejercicio01 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < respuestas.length; i++) {
            ...
            /* 
            El error era que existia un OR en vez de un AND, por lo que no
            existia un limite para cada rango aceptando todos los valores en el
            condicional, ya que siempre se cumplia alguna. Se soluciono esto
            cambiando el || por &&
             */
